...
const API_EVENTS  = `${API_BASE}/api/event`;
const API_DAFTAR  = `${API_BASE}/api/event/daftar`;
const API_SAYA    = `${API_BASE}/api/event/saya`;
const API_UBAH    = `${API_BASE}/api/event/ubah-stand`;
